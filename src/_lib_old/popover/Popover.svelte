<!-- https://github.com/bertybot/svelte-easy-popover/blob/update-to-floating-ui/src/Popover.svelte -->
...
<script lang="ts">
	import type { Placement, Middleware, ComputePositionReturn } from '@floating-ui/dom';
